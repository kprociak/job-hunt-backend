...
class AuthControllerTest extends TestCase
{
    ...
    public function testLogoutMethodReturnsErrorForUnauthenticatedUser()
    {
    ...
    public function testLogoutMethodReturnsSuccessForAuthenticatedUser()
    {
    ...
    public function testMeMethodReturnsUserForAuthenticatedUser()
    {
        $loginResponse = $this->postJson('/api/login', [
            'email' => 'test@example.dev',
            'password' => 'password1234',
